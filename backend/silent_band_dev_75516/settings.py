"""
Django settings for silent_band_dev_75516 project.
...
ROOT_URLCONF = 'silent_band_dev_75516.urls'
...
WSGI_APPLICATION = 'silent_band_dev_75516.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "silent_band_dev_75516 API",
    "DESCRIPTION": "API documentation for silent_band_dev_75516 App",
    "VERSION": "v1",
}
